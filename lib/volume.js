...
function filenameToSteps(filename, base) {
    ...
    var fullPath = path_1.resolve(base, filename);
...
var Volume = (function () {
    ...
    Volume.prototype.getLinkParentAsDirOrThrow = function (filenameOrSteps, funcName) {
        ...
        if (!link)
            throwError(ENOENT, funcName, path_1.sep + steps.join(path_1.sep));
        if (!link.getNode().isDirectory())
    ...
    Volume.prototype.fromJSON = function (json, cwd) {
        ...
        for (var filename in json) {
            ...
            filename = path_1.resolve(cwd, filename);
            var steps = filenameToSteps(filename);
            if (steps.length > 1) {
                var dirname_1 = path_1.sep + steps.slice(0, steps.length - 1).join(path_1.sep);
                this.mkdirpBase(dirname_1, 511 /* DIR */);
            }
    ...
    Volume.prototype.openLink = function (link, flagsNum, resolveSymlinks) {
        ...
        var file = new node_1.File(link, node, flagsNum, this.newFdNumber());
    ...
    Volume.prototype.readlinkBase = function (filename, encoding) {
        ...
        var str = path_1.sep + node.symlink.join(path_1.sep);
    ...
    Volume.prototype.watch = function (path, options, listener) {
        ...
        if (recursive === undefined)
            recursive = false;
        var watcher = new FSWatcher(this);
