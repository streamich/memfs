...
export interface FsSynchronousApi {
  ...
  fstatSync: {
    (fd: number, options: { bigint: false }): misc.IStats<number>;
    (fd: number, options: { bigint: true }): misc.IStats<bigint>;
  ...
  lstatSync: {
    (path: misc.PathLike, options: { bigint: false; throwIfNoEntry: false }): misc.IStats<number> | undefined;
    (path: misc.PathLike, options: { bigint: false; throwIfNoEntry?: true | undefined }): misc.IStats<number>;
    (path: misc.PathLike, options: { bigint: true; throwIfNoEntry: false }): misc.IStats<bigint> | undefined;
    (path: misc.PathLike, options: { bigint: true; throwIfNoEntry?: true | undefined }): misc.IStats<bigint>;
    (path: misc.PathLike, options: { throwIfNoEntry: false }): misc.IStats<number> | undefined;
    (path: misc.PathLike, options: { throwIfNoEntry?: true | undefined }): misc.IStats<number>;
    (path: misc.PathLike): misc.IStats<number>;
  };
  mkdirSync: {
    (path: misc.PathLike, options: opts.IMkdirOptions & { recursive: true }): string | undefined;
    (path: misc.PathLike, options?: misc.TMode | (opts.IMkdirOptions & { recursive?: false })): void;
  ...
  statSync: {
    (path: misc.PathLike, options: { bigint: false; throwIfNoEntry: false }): misc.IStats<number> | undefined;
    (path: misc.PathLike, options: { bigint: false; throwIfNoEntry?: true }): misc.IStats<number>;
    (path: misc.PathLike, options: { bigint: true; throwIfNoEntry: false }): misc.IStats<bigint> | undefined;
    (path: misc.PathLike, options: { bigint: true; throwIfNoEntry?: true }): misc.IStats<bigint>;
    (path: misc.PathLike, options: { throwIfNoEntry: false }): misc.IStats<number> | undefined;
    (path: misc.PathLike, options: { throwIfNoEntry?: true }): misc.IStats<number>;
    (path: misc.PathLike): misc.IStats<number>;
  };
